...
export const meta: MetaFunction = () => {
  return [
    ...
    { name: "description", content: "Advice Generator practice app" },
  ]
}
  ...
  return (
    <main className="bg-dark-blue h-screen w-screen">
      <section className="h-full w-full flex items-center justify-center px-4">
        <div className="bg-dark-grayish-blue w-full min-h-[315px] max-h-[315px] rounded-lg  flex flex-col items-center justify-center px-4 md:max-w-[540px] md:max-h-[332px] md:px-16 gap-6 relative">
          <h1 className="text-[11px] font-semibold text-neon-green tracking-[3.24px] uppercase md:text-[13px]">
